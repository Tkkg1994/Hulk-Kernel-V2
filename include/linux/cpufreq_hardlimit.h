...
#define CPUFREQ_HARDLIMIT_MAX_SCREEN_ON_STOCK	2214000
#else
#define CPUFREQ_HARDLIMIT_MAX_SCREEN_ON_STOCK	1890000
#endif
#ifdef CONFIG_CPU_OVERCLOCK
#define CPUFREQ_HARDLIMIT_MAX_SCREEN_OFF_STOCK	2214000
#else
#define CPUFREQ_HARDLIMIT_MAX_SCREEN_OFF_STOCK	1890000
#endif
#ifdef CONFIG_LOW_CPUCLOCKS
#define CPUFREQ_HARDLIMIT_MIN_SCREEN_ON_STOCK	81000
#else
#define CPUFREQ_HARDLIMIT_MIN_SCREEN_ON_STOCK	384000
#endif
#ifdef CONFIG_LOW_CPUCLOCKS
#define CPUFREQ_HARDLIMIT_MIN_SCREEN_OFF_STOCK	81000
#else
#define CPUFREQ_HARDLIMIT_MIN_SCREEN_OFF_STOCK	384000
#endif
#define CPUFREQ_HARDLIMIT_TOUCHBOOST_LO_DEFAULT	702000
#define CPUFREQ_HARDLIMIT_TOUCHBOOST_HI_DEFAULT	1782000
