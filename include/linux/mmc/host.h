...
#define MMC_CAP2_STOP_REQUEST	(1 << 19)	/* Allow stop ongoing request */
/* Use runtime PM framework provided by MMC core */
#define MMC_CAP2_CORE_RUNTIME_PM (1 << 20)
#define MMC_CAP2_SANITIZE	(1 << 21)		/* Support Sanitize */
/* Allows Asynchronous SDIO irq while card is in 4-bit mode */
#define MMC_CAP2_ASYNC_SDIO_IRQ_4BIT_MODE (1 << 22)

#define MMC_CAP2_HS400_1_8V	(1 << 23)        /* can support */
#define MMC_CAP2_HS400_1_2V	(1 << 24)        /* can support */
#define MMC_CAP2_CORE_PM	(1 << 25)        /* use PM framework */
#define MMC_CAP2_HS400		(MMC_CAP2_HS400_1_8V | \
				 MMC_CAP2_HS400_1_2V)
#define MMC_CAP2_DRIVER_TYPE_4	(1 << 26)	/* Host supports eMMC Driver Type 4 */
