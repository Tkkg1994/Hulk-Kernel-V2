...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[1]  = { {   81000, HFPLL, 2, 0x06 },  950000, 1050000, 1 },
	[2]  = { {  135000, HFPLL, 2, 0x0A },  950000, 1050000, 1 },
	[3]  = { {  189000, HFPLL, 2, 0x0E },  950000, 1050000, 1 },
	[4]  = { {  270000, HFPLL, 2, 0x14 },  950000, 1050000, 1 },
	[5]  = { {  378000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	[6]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
	[7]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1050000, 2 },
	[8]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 2 },
	[9]  = { {  594000, HFPLL, 1, 0x16 }, 1050000, 1050000, 2 },
	[10] = { {  648000, HFPLL, 1, 0x18 }, 1050000, 1050000, 4 },
	[11] = { {  702000, HFPLL, 1, 0x1A }, 1150000, 1150000, 4 },
	[12] = { {  756000, HFPLL, 1, 0x1C }, 1150000, 1150000, 4 },
	[13] = { {  810000, HFPLL, 1, 0x1E }, 1150000, 1150000, 4 },
	[14] = { {  864000, HFPLL, 1, 0x20 }, 1150000, 1150000, 4 },
	[15] = { {  918000, HFPLL, 1, 0x22 }, 1150000, 1150000, 5 },
	[16] = { {  972000, HFPLL, 1, 0x24 }, 1150000, 1150000, 5 },
	[17] = { { 1026000, HFPLL, 1, 0x26 }, 1150000, 1150000, 5 },
	[18] = { { 1080000, HFPLL, 1, 0x28 }, 1150000, 1150000, 5 },
	[19] = { { 1134000, HFPLL, 1, 0x2A }, 1150000, 1150000, 5 },
#else
